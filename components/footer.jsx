...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="information mt-4 p-6 flex xs:justify-around sm:justify-around 2sm:justify-around md:justify-around lg:justify-around xl:justify-around 2xl:justify-around">
        ...
        <div className="">
          ...
          <div className="link flex text-lg xs:text-sm flex-col sm:text-sm mt-4 2sm:text-sm sm:text-xs md:text-base lg:text-base xl:text-base 2xl:text-base">
      ...
      <div className="copy text-base xs:text-sm flex items-center justify-around mt-4 sm:text-xs 2sm:text-sm">
